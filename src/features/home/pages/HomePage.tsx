    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4 py-12">
      <div className="max-w-3xl space-y-6">
        <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight">
          Track every cinematic journey
        </h1>

        <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed">
          Log where and when you watched your favorite movies and dive into your
          personal viewing statistics.
        </p>
        <p className="text-lg font-semibold text-blue-600 dark:text-blue-400">
          Own your movie data. No ads, no tracking, just you and the movies.
        </p>

        <p className="text-gray-500 dark:text-gray-400 italic">
          Made for people who love watching their stats as much as the movies
          themselves.
        </p>
      </div>
      ...
      <div className="mt-20 pt-12 border-t border-gray-100 dark:border-white/10 w-full max-w-2xl">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-lg mx-auto">
          This project is open source. Whether it's fixing bugs, adding
          features, or improving documentation, your help is appreciated!
        </p>
